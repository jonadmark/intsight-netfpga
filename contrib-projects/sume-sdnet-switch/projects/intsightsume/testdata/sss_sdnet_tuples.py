...
dig_field_len['unused'] = 80
dig_field_len['drops'] = 16
dig_field_len['txbytes'] = 16
dig_field_len['txpkts'] = 16
dig_field_len['rxbytes'] = 16
dig_field_len['rxpkts'] = 16
dig_field_len['high_delays'] = 16
dig_field_len['contention_points'] = 8
dig_field_len['path_dst'] = 8
dig_field_len['path_code'] = 8
dig_field_len['path_length'] = 8
dig_field_len['path_src'] = 8
dig_field_len['flow_ID'] = 8
dig_field_len['epoch'] = 32

#initialize tuple_expect
dig_tuple_expect = collections.OrderedDict()
# dig_tuple_expect['unused'] = 0
dig_tuple_expect['unused'] = 0
dig_tuple_expect['drops'] = 0
dig_tuple_expect['txbytes'] = 0
dig_tuple_expect['txpkts'] = 0
dig_tuple_expect['rxbytes'] = 0
dig_tuple_expect['rxpkts'] = 0
dig_tuple_expect['high_delays'] = 0
dig_tuple_expect['contention_points'] = 0
dig_tuple_expect['path_dst'] = 0
dig_tuple_expect['path_code'] = 0
dig_tuple_expect['path_length'] = 0
dig_tuple_expect['path_src'] = 0
dig_tuple_expect['flow_ID'] = 0
dig_tuple_expect['epoch'] = 0
